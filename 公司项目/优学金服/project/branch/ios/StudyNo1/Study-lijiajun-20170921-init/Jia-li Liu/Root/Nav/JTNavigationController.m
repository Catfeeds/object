...
- (void)pushViewController:(UIViewController *)viewController animated:(BOOL)animated {
    ...
    viewController.navigationItem.leftBarButtonItem.tintColor =  viewController.navigationItem.rightBarButtonItem.tintColor = AppNavTitleColor;
...
+ (void)load
{
    ...
    dic[NSForegroundColorAttributeName] = AppNavTitleColor;
    [item setTitleTextAttributes:dic forState:UIControlStateNormal];
    
    UINavigationBar *bar = [UINavigationBar appearanceWhenContainedInInstancesOfClasses:@[self]];
    
    // APP颜色
    [bar setBackgroundImage:[UIImage imageWithColor:AppNavBarColor] forBarMetrics:UIBarMetricsDefault];
