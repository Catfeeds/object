...
- (void)layoutSubviews
{
    ...
    //调整发布按钮的中线点Y值
    self.plusBtn.centerY = self.height * 0.5 - 3*LBMagin  ;
    ...
    //调整文字位置
    self.title.frame = CGRectMake(self.plusBtn.frame.origin.x, self.plusBtn.frame.origin.y+self.plusBtn.frame.size.height+5, self.plusBtn.frame.size.width, 15);
