...
public class ConfigConstants {
	 ...
	 * Package name.
	 */
	public final static String Package = "com.zw.archer.config";
	...
	public final static class Schedule {
		 ...
		 * 每日体验标是否开启
		 */
		public static final String ENABLE_TASTE_INVEST = "schedule.enable_taste_invest";
		/**
		 * 体验标可领取利息的天数
		 */
		public static final String PAY_DAYS="schedule.pay_days";
		/**
		 * 是否开启无忧宝自动投标
		 */
		public static final String AUTO_LOAN = "enable_auto_loan";
		/**
		 * 是否开启满标放款
		 */
		public static final String LOANCOMPLETELOANMONEY = "loanCompleteLoanMoney";
		/**
		 * 自动投资超时时返还当前可投的本息的超时时间
		 */
		public static final String AUTO_LOAN_OUTTIME = "auto_loan_outtime";
		/**
		 * 无忧保金额不能大于当前平台所有未满标的剩余金额总和的百分比
		 */
		public static final String NEWSAFELOANPER = "SAFELOANPER";
	}
	...
	public final static class InvestTransfer {
		 ...
		 * 后台注册红包金额
		 */
		public static final String COUPON_MONEY_ADMIN="coupon_money_admin";
	...
	public final static class VirtualLoan{
		public final static String INVEST="tiyanbiaoid";
	}
