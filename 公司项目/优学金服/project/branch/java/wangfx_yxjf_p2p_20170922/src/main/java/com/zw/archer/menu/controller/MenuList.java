...
public class MenuList extends EntityQuery<Menu> implements java.io.Serializable {
	...
	private List<com.zw.archer.menu.model.TreeNode> menuTree;
	...
	private com.zw.archer.menu.model.TreeNode createNewNode(String id,
			String label) {
		com.zw.archer.menu.model.TreeNode node = new com.zw.archer.menu.model.TreeNode();
		node.setId(id);
		node.setLabel(label);
		return node;
	}

	public List<com.zw.archer.menu.model.TreeNode> getMenuTree() {
		menuTree = new ArrayList<com.zw.archer.menu.model.TreeNode>();
				...
				if (menu.getParent() == null
						&& !menu.getId()
								.equals(((Menu) FacesUtil
										...
										.getId())) {
					com.zw.archer.menu.model.TreeNode node = createNewNode(
	...
	public void setMenuTree(List<com.zw.archer.menu.model.TreeNode> menuTree) {
