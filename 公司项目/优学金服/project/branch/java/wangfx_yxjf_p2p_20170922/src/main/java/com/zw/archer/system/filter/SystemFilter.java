package com.zw.archer.system.filter;
...
import com.zw.archer.system.service.AppLocalFilter;
...
public class SystemFilter implements Filter{
	...
	private final static String FILTER_SERVICE_IMPL_PACKAGE = "com.zw.archer.system.service.impl";
	...
	public void init(FilterConfig config) throws ServletException {
		...
		final String filterServices = config.getInitParameter(FILTER_SERVICE_NAME);
		...
		for(int i = 0 ;i < services.length ;i++ ){
			filters[i] = (AppLocalFilter) SpringBeanUtil.getBeanByName(services[i]);
			if( filters[i] == null){
