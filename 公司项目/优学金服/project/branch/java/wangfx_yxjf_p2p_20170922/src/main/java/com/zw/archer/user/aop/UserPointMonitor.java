package com.zw.archer.user.aop;
...
import com.zw.archer.user.UserConstants.UserPointType;
import com.zw.archer.user.service.UserPointService;
...
public class UserPointMonitor {
	 ...
	 * @param role
	 */
	@AfterReturning(argNames = "loanId", value = "execution(public void com.zw.p2p.loan.service.LoanService.giveMoneyToBorrower(..)) && args(loanId)")
