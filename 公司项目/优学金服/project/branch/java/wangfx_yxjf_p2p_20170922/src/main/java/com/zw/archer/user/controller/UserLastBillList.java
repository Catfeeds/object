...
public class UserLastBillList extends EntityQuery<UserBill> {
	...
	public UserLastBillList() {
		...
		final String[] RESTRICTIONS = { "id like #{userLastBillList.example.id}",
//				"ub.user.id like #{userLastBillList.example.user.id}",
				"ub.user.id like #{userLastBillList.userName}",
				"ub.user.realname like #{userLastBillList.realName}",
				"ub.type like #{userLastBillList.example.type}",
				"ub.typeInfo like #{userLastBillList.example.typeInfo}",
				"ub.time >= #{userLastBillList.startTime}",
				"ub.time <= #{userLastBillList.endTime}" };
