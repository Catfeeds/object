...
public interface UserService {
	 ...
	 * @throws UserNotFoundException
	 */
	public String sendFindLoginPasswordLinkEmail(String email) throws UserNotFoundException;
	 ...
	 * @throws UserNotFoundException
	 */
	public String sendBindingEmail(String userId, String email) throws UserNotFoundException;
	 ...
	 * @throws UserNotFoundException
	 */
	public String sendChangeBindingEmail(String userId, String oriEmail) throws UserNotFoundException;
	 ...
	 * @throws AuthInfoAlreadyActivedException 
	 */
	public void registerByMobileNumber(User user, String authCode, String referrer) throws NoMatchingObjectsException, AuthInfoOutOfDateException, AuthInfoAlreadyActivedException,Exception;
	 ...
	 * 
	 */
	public void sendFindCashPwdSMS(String id, String mobileNumber) throws SendSMSException;
	/**
	 * 通过汇付获得身份号等信息进行实名认证
	 * @param user
	 */
	...
	/**
	*@Description: TODO(获得所有需要同步银行卡的人) 
	* @author cuihang   
	*@date 2017-4-17 上午9:46:59 
	*@return
	 */
