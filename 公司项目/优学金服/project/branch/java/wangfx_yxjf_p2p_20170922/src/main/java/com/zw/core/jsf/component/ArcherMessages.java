package com.zw.core.jsf.component;
...
@ResourceDependencies({
		...
		@ResourceDependency(library = "zw", name = "style/archerMessage.css"),
		@ResourceDependency(library = "zw", name = "js/archerMessages.js", target = "head") })
public class ArcherMessages extends OnloadScript {
	...
	public static final String COMPONENT_TYPE = "com.zw.core.component.ArcherMessages";
