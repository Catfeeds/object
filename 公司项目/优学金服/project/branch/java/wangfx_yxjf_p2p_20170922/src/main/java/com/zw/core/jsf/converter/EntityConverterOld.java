package com.zw.core.jsf.converter;
...
@FacesConverter("archer.EntityConverterTest")
public class EntityConverterOld extends ValueChangeConverter {

	private static final String ID_PREFIX = "entityConverter_";

	public Object getAsChangedObject(FacesContext context, UIComponent component,
			String value) {
		if (value != null) {
