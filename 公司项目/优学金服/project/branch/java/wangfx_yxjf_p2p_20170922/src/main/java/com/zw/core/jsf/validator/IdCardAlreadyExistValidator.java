...
@FacesValidator(value = "com.zw.core.validator.IdCardAlreadyExistValidator")
public class IdCardAlreadyExistValidator extends ValueChangeValidator implements
		PartialStateHolder {

	public static final String VALIDATOR_ID = "com.zw.core.validator.IdCardAlreadyExistValidator";
