...
import com.zw.archer.common.exception.InputRuleMatchingException;
...
@FacesValidator(value = "com.zw.core.validator.InputRuleValidator")
public class InputRuleValidator extends ValueChangeValidator implements
		PartialStateHolder {

	public static final String VALIDATOR_ID = "com.zw.core.validator.InputRuleValidator";
