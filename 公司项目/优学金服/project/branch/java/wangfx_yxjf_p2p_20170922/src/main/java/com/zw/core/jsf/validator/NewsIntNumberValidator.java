...
//@Component
@FacesValidator(value = "com.zw.core.validator.NewsIntNumberValidator")
public class NewsIntNumberValidator extends ValueChangeValidator implements
		PartialStateHolder {

	public static final String VALIDATOR_ID = "com.zw.core.validator.NewsIntNumberValidator";
	...
	public void restoreState(FacesContext context, Object state) {
		...
		if (state != null) {
			...
			cardinalNumber = (Integer) values[1];
		}
	}
