...
@Component
@FacesValidator(value = "com.zw.core.validator.PersistenceValueValidator")
public class PersistenceValueValidator extends ValueChangeValidator implements
		PartialStateHolder {

	public static final String VALIDATOR_ID = "com.zw.core.validator.PersistenceValueValidator";
				...
				if (StringUtils.isNotEmpty(message)) {
					...
					throw new ValidatorException(
							MessageFactory
									.getMessage(
											context,
											"com.zw.core.validator.AlreadyExistValidator.PERSISTENCE_VALUE",
