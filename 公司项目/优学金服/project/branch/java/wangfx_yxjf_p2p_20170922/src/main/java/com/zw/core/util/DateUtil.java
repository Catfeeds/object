...
public class DateUtil {
	...
	public static void main(String[] args){
		...
		dt= DateUtil.StringToDate("2015-02-25");
		System.out.println(DateUtil.getDate(DateUtil.addDay(dt, 30)));
		System.out.println(DateUtil.getDate(DateUtil.addMonth(dt, 1)));
	}
}