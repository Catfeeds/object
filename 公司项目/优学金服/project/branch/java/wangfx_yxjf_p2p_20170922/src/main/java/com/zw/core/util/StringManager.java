...
import com.zw.archer.Constants;
...
public class StringManager {
    ...
    public String getString(String key) {
        ...
        try{
	        ...
	        if(str == null){
	        	StringManager.getManager(Constants.APP_BASE_PATH).getString(key);
	        }
   ...
   public synchronized static StringManager getManager(String packageName,Locale loc) {
	 ...
	 * @return
	 */
	public static String getReplaceString (String  str,int head ,int foot){
		String result="";
		String string="";
		if (foot == 0 && head == 0){
			return str;
		...
		for (int i = 0;i<str.length() - head - foot; i ++){
			string += "*";
		}
		if(null==str||"".equals(str.toString())){
			result = str;
		}else if (head + foot > str.length()){
			result = str;
		}else if (head < 0 || foot < 0){
			result = str;
		}else {
			result = str.substring(0,head) + string + str.substring(str.length() - foot);
		}
		return  result;
	}
    public static String getReplaceString (String  str,Integer num){
        String result="";
        if(null==str||"".equals(str.toString())){
            return  result;
        }
        ...
        result=str.substring(0,num)+"**"+str.substring(str.length()-num);
        return  result;
    }
    public static String getReplaceAfterString (String  str,Integer num){
        String result="";
        if(null==str||"".equals(str.toString())){
            return  result;
        }
    ...
    public static void  main(String[] args){
        System.out.println(getReplaceString("1111",0,2));
    }
}
