...
import com.zw.p2p.invest.service.AutoInvestService;
...
public class AutoInvestServiceImpl implements AutoInvestService {
	 ...
	 * 
	 * @see
	 * com.zw.p2p.invest.service.impl.AutoInvestService#settingAutoInvest
	 * (com.zw.p2p.invest.model.AutoInvest)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * com.zw.p2p.invest.service.impl.AutoInvestService#autoInvest(java
	 * .lang.String)
	 */
	@Override
	@Async
...
//				    c）轮到用户投标时没有符合用户条件的标，该用户会继续保持在最前，只到投入。
	 ...
	 * 自动投资成功发送信息
	 */
	public void sendAutoInvestMsg(AutoInvest ai,Loan loan){
		User user = ai.getUser();
		Map<String,String> params  = new HashMap<String, String>();
		params.put("username",user.getUsername());
		params.put("money",ai.getInvestMoney()+"");
