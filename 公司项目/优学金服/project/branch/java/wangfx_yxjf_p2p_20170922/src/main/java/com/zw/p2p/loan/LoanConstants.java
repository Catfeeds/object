package com.zw.p2p.loan;

public class LoanConstants {
	/**
	 * Package name.
	 */
	public final static String Package = "com.zw.archer.loan";
	...
	public final static class LoanStatus {
		 ...
		 * 等待放款
		 */
		public final static String FINANCIALLOAN = "financialLoan";
	...
	public final static class RepayStatus {
		 ...
		 * 结息中
		 */
		public final static String INTERESTING = "interesting";
		/**
		 * 等待还款确认*/
		public final static String WAIT_REPAY_VERIFY = "wait_repay_verify";
		/**
	...
	public final static class LoanVerifyStatus {
		 ...
		 * 汇付审核
		 */
		public final static String HUIFUCHECK = "汇付审核";
		/**
		 * 未通过
		 */
