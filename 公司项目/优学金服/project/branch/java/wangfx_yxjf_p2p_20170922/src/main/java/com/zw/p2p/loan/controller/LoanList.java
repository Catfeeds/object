...
import com.zw.p2p.statistics.controller.LoanStatistics;

/**
 * Description: 借款查询相关 Copyright: Copyright (c)2013 Company: p2p
 * 
 * @author: yinjunlu
...
//
//		//TODO status 待确认,by lijin ,2015-1-28
//		switch (sId) {
//			case 0://全部
//				statusQuery = "";
//				break;
//			case 1://等待开标
//				statusQuery = "(loan.status in ('waiting_verify','dqgs','waiting_verify_affirm','waiting_verify_affirm_user'))";
//				break;
//			case 2://招标中
//				statusQuery = "(loan.status in ('raising'))";
//				break;
//			case 3://满标待审
//				statusQuery = "(loan.status in ('recheck','financialLoan','waiting_recheck_verify'))";
//				break;
//			case 4://还款中
...
//	}
	...
	public double getAllLoansMoney() {
	  ...
	  /**
		*@Description: TODO(得到第一个推荐项目) 
		* @author cuihang   
		*@date 2016-4-5 下午5:11:41 
		*@return
		 */
		public Loan getFirstTuiJian(){
			Loan loan=	loanService.findLoanById(configService.getConfigValue("indexreco"));
			if(null!=loan&&loan.getStatus().equals(LoanStatus.RAISING)){
				return loan;
			}
			return loanService.getFirstTuiJian();
		}
