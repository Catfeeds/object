package com.zw.p2p.message.aop;
...
import com.zw.p2p.message.MessageConstants.UserMessageNodeId;
...
public class MessageMonitor {
	 ...
	 * @param role
	 */
	@AfterReturning(argNames = "recharge", value = "execution(public void com.zw.p2p.user.service.impl.RechargeBO.rechargeSuccess(..)) && args(recharge)")
	 ...
	 * @param role
	 */
	@AfterReturning(argNames = "loan", value = "execution(public void com.zw.p2p.loan.service.LoanService.passApply(..)) " +
			"&& args(loan)")
...
//	 * @param invest
//	 */
//	@AfterReturning(argNames = "invest", value = "execution(public void com.zw.p2p.invest.service.InvestService.create(..)) && args(invest)")
