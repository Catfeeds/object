...
import com.zw.p2p.repay.model.AdvanceRepay;
...
public class RepayCalculatorImpl implements RepayCalculator {
	...
	public AdvanceRepay calculateAdvanceRepay(String loanId) {
		...
		ar.setCorpus(ArithUtil.round(sumCorpus,2));
		ar.setRepayFee(ArithUtil.round(feeAll,2));
		ar.setFeeToInvestor(ArithUtil.round(feeToInvestor,2));
		ar.setFeeToSystem(ArithUtil.round(feeToSystem,2));
		return ar;
	}
