...
import com.zw.p2p.risk.FeeConfigConstants.OperateMode;
import com.zw.p2p.risk.exception.NotContinuityIntervalException;
...
public class FeeConfigBO {
	 ...
	 * @return
	 */
	public double getFee(String fcId){
		FeeConfig feeConfig = ht.get(FeeConfig.class,fcId);
		double fee = feeConfig.getFee();
		return fee;
	}
