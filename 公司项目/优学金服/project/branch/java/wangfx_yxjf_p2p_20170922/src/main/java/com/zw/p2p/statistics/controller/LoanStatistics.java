...
public class LoanStatistics {
	...
	public Long getLoanRSCount(String businessType) {
		String hql = "select count(loan) from Loan loan where loan.status not in(?,?) and loan.businessType=? and loan.loantypeb='ea38ad9c7e3140f5891720aad0efa30d'";
		List<Object> oos = ht.find(hql, new String[] { LoanStatus.CANCEL,LoanStatus.VERIFY_FAIL,businessType });
		Object o = oos.get(0);
		if (o == null) {
			return 0L;
		}
	 ...
	 * @return
	 */
	public Long getLoanRSCount2(String businessType) {
		String hql = "select count(loan) from Loan loan where loan.status not in(?,?) and loan.businessType=? and loan.loantypeb='xsdb326c5b664870b698739e93f2d6xs'";
		List<Object> oos = ht.find(hql, new String[] { LoanStatus.CANCEL,LoanStatus.VERIFY_FAIL,businessType });
		Object o = oos.get(0);
		if (o == null) {
			return 0L;
	...
	public Long getRaisingLoanCount() {
		String hql = "select count(loan) from Loan loan where loan.status=? and loan.expectTime>NOW() and loan.loantypeb='ea38ad9c7e3140f5891720aad0efa30d'";
		List<Object> oos = ht.find(hql, new String[]{LoanStatus.RAISING});
		Object o = oos.get(0);
		if (o == null) {
			return 0L;
		}
	 ...
	 * @return
	 */
	public Long getRaisingLoanCount2() {
		String hql = "select count(loan) from Loan loan where loan.status=? and loan.expectTime>NOW() and loan.loantypeb='xsdb326c5b664870b698739e93f2d6xs'";
		List<Object> oos = ht.find(hql, new String[]{LoanStatus.RAISING});
		Object o = oos.get(0);
		if (o == null) {
			return 0L;
