package com.zw.p2p.trusteeship.service;
...
import com.zw.p2p.trusteeship.exception.TrusteeshipReturnException;
import com.zw.p2p.trusteeship.model.TrusteeshipOperation;
...
public interface TrusteeshipOperationService<T> {
	 ...
	 */
	public TrusteeshipOperation createOperation(T t, FacesContext facesContext) throws IOException;
